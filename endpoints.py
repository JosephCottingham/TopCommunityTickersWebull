class urls :
    ...
    def social_posts(self, topic, num=100):
        ...
        # /social/activity/index/up/ranks/new?hasNum=8&roundId=164739450905976832
        # /social/activity/message?activityId=ptc_200224
        # /social/feed/topic/at_ptc_200224/posts
